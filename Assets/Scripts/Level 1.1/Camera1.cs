...
public class Camera1 : MonoBehaviour
{
    ...
    public static void GameEnd()
    {
        ...
        // AudioListener.pause = true;
        // Camera1.CameraObj.GameoverBGM.Play();
        Camera1.camObj.updateBGM();

        // Debug.Log("Printing   "+Camera1.camObj.GameoverBGM);
        // Camera1.camObj.GameoverBGM.Play();
        GameObject[] scoreA;
        GameObject[] healthA;
