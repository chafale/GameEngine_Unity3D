...
using gs = goldScript32;
using mapgen = MapGenerator32;
using gamsta = gameStatus32;
using pl = Player;
using hb = HealthBar;
...
public class Destroy32 : MonoBehaviour
{
    public int check;
    public int goCheck;
    public static Destroy32 destroyObj;
    ...
    void OnCollisionEnter(Collision collide) {
        ...
        GameManager32 gameManager = GameObject.Find("GameManager").GetComponent<GameManager32>();
