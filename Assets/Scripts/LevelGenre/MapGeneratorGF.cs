...
public class MapGeneratorGF : MonoBehaviour {
	...
	public GameObject speedObject, autofillObject, healthUpObject, splitObject, hintObject;
	...
	GameObject GenerateCharacter(float start, float end, float obj1, float obj2, float obj3, float obj4) {
		...
		// else if((count==2 || count%5==0) && GameManagerGF.hints>0 && GameManagerGF.hints<=3){
