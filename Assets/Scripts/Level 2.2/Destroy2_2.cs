...
using gs = goldScript2_2;
using mapgen = MapGenerator2_2;
using gamsta = gameStatus2_2;
using pl = Player;
using hb = HealthBar;

public class Destroy2_2 : MonoBehaviour
{
    public int check;
    public int healCheck;
    public int healCount = 0;
    public static Destroy2_2 destroyObj;
    ...
    void OnCollisionEnter(Collision collide) {
        ...
        GameManager2_2 gameManager = GameObject.Find("GameManager").GetComponent<GameManager2_2>();
