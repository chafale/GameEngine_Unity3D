...
using des = Destroy2_2;
using mg = GameManager2_2;


public class gameStatus2_2 : MonoBehaviour
{
    ...
    public static gameStatus2_2 gameStatusObj;
    public static int score = MapGenerator2_2.displayCharacter.Count;
