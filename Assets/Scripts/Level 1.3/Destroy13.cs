...
using gs = goldScript13;
using mapgen = MapGenerator13;
using gamsta = gameStatus13;
using pl = Player;
using hb = HealthBar;
...
{
    public int check;
    public static Destroy13 destroyObj;
    ...
    void OnCollisionEnter(Collision collide) {
        ...
        GameManager13 gameMananger = GameObject.Find("GameManager").GetComponent<GameManager13>();
