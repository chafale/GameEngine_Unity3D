...
using mapgen = MapGenerator13;
using mg = GameManager13;
using pl = Player;

public class Camera13 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else
        {
            ...
            {
                gameStatus13.gameStatusObj.updateStatus();
            }
            Camera13.GameEnd();
