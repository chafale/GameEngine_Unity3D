...
using des = Destroy_43;
using mg = GameManager_43;


public class gameStatus_43 : MonoBehaviour
{
    ...
    public static gameStatus_43 gameStatusObj;
    public static int score = MapGenerator_43.displayCharacter.Count;
