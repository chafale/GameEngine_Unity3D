...
using des = Destroy2_1;
using mg = GameManager2_1;


public class gameStatus2_1 : MonoBehaviour
{
    ...
    public static gameStatus2_1 gameStatusObj;
    public static int score = MapGenerator2_1.displayCharacter.Count;
