...
using gs = goldScript2_1;
using mapgen = MapGenerator2_1;
using gamsta = gameStatus2_1;
using pl = Player;
using hb = HealthBar;

public class Destroy2_1 : MonoBehaviour
{
    public int check;
    public int healCheck;
    public int healCount = 0;
    public static Destroy2_1 destroyObj;
    ...
    void OnCollisionEnter(Collision collide) {
        ...
        GameManager2_1 gameManager = GameObject.Find("GameManager").GetComponent<GameManager2_1>();
