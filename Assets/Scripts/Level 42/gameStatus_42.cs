...
using des = Destroy_42;
using mg = GameManager_42;


public class gameStatus_42 : MonoBehaviour
{
    ...
    public static gameStatus_42 gameStatusObj;
    public static int score = MapGenerator_42.displayCharacter.Count;
