...
using TMPro;
using gs = goldScript_42;
using mg = MapGenerator_42;

public class GameManager_42 : MonoBehaviour
{
    ...
    void Start(){
        ...
        PlayerPrefs.SetString("levelName", "Level 4-2");
    ...
    public static GameManager_42 gamag;
